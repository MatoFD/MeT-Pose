...
def do_dataframe_csv_translation(base_folder, datasets_and_types_list, save_raw_diffs, save_raw_keypoints):
    base_folder = base_folder
    for dataset, data_type in datasets_and_types_list:
